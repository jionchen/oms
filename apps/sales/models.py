...
class SalesOrder(models.Model):
    ...
    seller = models.ForeignKey('user.User', models.SET_NULL, related_name='sales_orders', null=True)
    seller_name = models.CharField(max_length=64)
    warehouse = models.ForeignKey('warehouse.Warehouse', models.SET_NULL, related_name='sales_orders', null=True)
    warehouse_name = models.CharField(max_length=64)
    account = models.ForeignKey('account.Account', models.SET_NULL, related_name='sales_orders', null=True)
    ...
    client = models.ForeignKey('sales.Client', models.SET_NULL, related_name='sales_orders', null=True)
    ...
    teams = models.ForeignKey('user.Teams', models.CASCADE, related_name='sales_orders')
...
class SalesGoods(models.Model):
    ...
    teams = models.ForeignKey('user.Teams', models.CASCADE, related_name='sales_goods_set')
...
class SalesReturnOrder(models.Model):
    ...
    number = models.CharField(max_length=32)
    date = models.DateTimeField()
    seller = models.ForeignKey('user.User', models.SET_NULL, related_name='sales_return_orders', null=True)
    seller_name = models.CharField(max_length=64)
    warehouse = models.ForeignKey('warehouse.Warehouse', models.SET_NULL, related_name='sales_return_orders', null=True)
    warehouse_name = models.CharField(max_length=64)
    account = models.ForeignKey('account.Account', models.SET_NULL, related_name='sales_return_orders', null=True)
    account_name = models.CharField(max_length=64)
    amount = models.FloatField(default=0)  # 实退金额
    total_amount = models.FloatField(default=0)  # 应退金额
    total_quantity = models.FloatField(default=0)  # 总数量
    client = models.ForeignKey('sales.Client', models.SET_NULL, related_name='sales_return_orders', null=True)
    client_name = models.CharField(max_length=64, null=True, blank=True)
    client_phone = models.CharField(max_length=12, null=True, blank=True)
    client_address = models.CharField(max_length=256, null=True, blank=True)
    remark = models.CharField(max_length=256, null=True, blank=True)
...
class SalesReturnGoods(models.Model):
    """销售退货商品"""
    number = models.CharField(max_length=32)
    name = models.CharField(max_length=256)
    unit = models.CharField(max_length=16, null=True, blank=True)  # 单位
    ...
    amount = models.FloatField(default=0)  # 金额
    remark = models.CharField(max_length=256, null=True, blank=True)
    goods = models.ForeignKey('goods.Goods', models.SET_NULL, related_name='sales_return_goods_set', null=True)
    sales_return_order = models.ForeignKey('sales.SalesReturnOrder', models.CASCADE, related_name='goods_set')
